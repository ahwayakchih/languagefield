<?php
	Class extension_languageField extends Extension{
		...
		public function about(){
			return array('name' => 'Field: Language',
						 'version' => '1.0',
						 'release-date' => '2009-03-04',
						 'author' => array('name' => 'Marcin Konicki',
										   'website' => 'http://ahwayakchih.neoni.net',
										   'email' => 'ahwayakchih@neoni.net'),
						 'description' => 'Adds browser-languages parameter to list of all parameters available for data-sources and XSLT to use. Enables language field.'
			);
		}
